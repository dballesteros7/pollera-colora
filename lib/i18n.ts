...
const M: Record<string, Msg> = {
  // ---- shared / shell ----
  "tab.table": { es: "Tabla", en: "Table", de: "Tabelle", it: "Classifica", pt: "Tabela", fr: "Classement", zh: "积分榜", zht: "積分榜" },
  ...
  "badge.final": { es: "final", en: "final", de: "Endstand", it: "finale", pt: "final", fr: "terminé", zh: "已结束", zht: "已結束" },
  "badge.tbd": { es: "por definir", en: "TBD", de: "offen", it: "da definire", pt: "a definir", fr: "à définir", zh: "待定", zht: "待定" },
  "badge.organiza": { es: "{name} organiza", en: "{name} organizes", de: "{name} organisiert", it: "organizza {name}", pt: "{name} organiza", fr: "{name} organise", zh: "{name} 主持", zht: "{name} 主持" },
  ...
  // ---- home / landing ----
  "hero.title1": { es: "¡Se armó", en: "Game on —", de: "Auf geht's —", it: "Si parte —", pt: "Começou —", fr: "C'est parti —", zh: "开赛啦 —", zht: "開賽啦 —" },
  ...
  "landing.sub": {
    ...
    fr: "Le pronostic colombien du Mondial 2026 pour ta bande. Pronostics, questions folles et un classement pour se chamailler.", zh: "哥伦比亚风格的 2026 世界杯竞猜，和朋友们一起玩。预测比分、回答搞怪问题、为排名争个不停。",
  ...
  "name.title": { es: "¡Quiubo!", en: "You're in!", de: "Du bist drin!", it: "Ci sei!", pt: "Chegou!", fr: "Te voilà !", zh: "欢迎！", zht: "歡迎！" },
  ...
  "name.placeholder": { es: "Como le dicen en el parche", en: "What your crew calls you", de: "Wie dich deine Crew nennt", it: "Come ti chiama la banda", pt: "Como a galera te chama", fr: "Comme t'appelle ta bande", zh: "朋友们对你的称呼", zht: "朋友們對你的稱呼" },
  ...
  "home.emptyBody": {
    ...
    fr: "Crée ta propre polla ou demande le lien à l'organisateur de ta bande.", zh: "创建自己的竞猜，或向组织者要邀请链接。",
  ...
  "home.youOrganize": { es: "Usted organiza esta polla", en: "You organize this polla", de: "Du organisierst diese Polla", it: "Organizzi tu questa polla", pt: "Você organiza este bolão", fr: "Tu organises cette polla", zh: "你是这个竞猜的主持人", zht: "你是這個競猜的主持人" },
  "home.member": { es: "Es del parche", en: "You're in the crew", de: "Du bist dabei", it: "Sei della banda", pt: "Você está na galera", fr: "Tu fais partie de la bande", zh: "你已加入", zht: "你已加入" },

  // ---- login ----
  "login.sub": { es: "Entre al parche y meta sus pronósticos.", en: "Join your crew and get your predictions in.", de: "Komm zu deiner Crew und gib deine Tipps ab.", it: "Entra nella banda e piazza i tuoi pronostici.", pt: "Entre na galera e mande seus palpites.", fr: "Rejoins ta bande et place tes pronostics.", zh: "加入朋友们，开始预测比分。", zht: "加入朋友們，開始預測比分。" },
  "login.email": { es: "Su correo", en: "Your email", de: "Deine E-Mail", it: "La tua email", pt: "Seu e-mail", fr: "Ton e-mail", zh: "你的邮箱", zht: "你的電子郵件" },
  ...
  "login.codeMailed": { es: "Se lo mandamos al correo", en: "We mailed it to you", de: "Wir haben ihn dir gemailt", it: "Te l'abbiamo mandato via email", pt: "Mandamos pro seu e-mail", fr: "On te l'a envoyé par e-mail", zh: "已发送到你的邮箱", zht: "已傳送到你的信箱" },
  ...
  "err.email": { es: "Ingrese un correo válido.", en: "Enter a valid email.", de: "Gib eine gültige E-Mail ein.", it: "Inserisci un'email valida.", pt: "Digite um e-mail válido.", fr: "Saisis un e-mail valide.", zh: "请输入有效的邮箱地址。", zht: "請輸入有效的電子郵件。" },
  "err.rate": { es: "Demasiados códigos pedidos. Espere unos minutos.", en: "Too many codes requested. Wait a few minutes.", de: "Zu viele Codes angefordert. Warte ein paar Minuten.", it: "Troppi codici richiesti. Aspetta qualche minuto.", pt: "Muitos códigos pedidos. Espere alguns minutos.", fr: "Trop de codes demandés. Attends quelques minutes.", zh: "请求验证码次数过多，请稍等几分钟。", zht: "請求驗證碼次數過多，請稍等幾分鐘。" },
  ...
  "join.badLinkBody": {
    ...
    fr: "Ce lien n'existe pas ou a été renouvelé. Demande un nouveau lien à l'organisateur de la polla.", zh: "该链接不存在或已更新。请向组织者索取新链接。",
  ...
  "join.more": { es: "+ {n} más", en: "+ {n} more", de: "+ {n} weitere", it: "+ altri {n}", pt: "+ {n} mais", fr: "+ {n} autres", zh: "还有 {n} 人", zht: "還有 {n} 人" },
  "join.players": { es: "{n} jugador(es)", en: "{n} player(s)", de: "{n} Spieler", it: "{n} giocatori", pt: "{n} jogador(es)", fr: "{n} joueur(s)", zh: "{n} 名玩家", zht: "{n} 名玩家" },
  ...
  "join.noMoney": { es: "No se mueve plata por la app.", en: "No money moves through the app.", de: "Über die App fließt kein Geld.", it: "Nessun soldo passa per l'app.", pt: "Nenhum dinheiro passa pelo app.", fr: "Aucun argent ne passe par l'appli.", zh: "应用内不涉及任何金钱。", zht: "應用程式內不涉及任何金錢。" },
  ...
  "explain.body": {
    ...
    fr: "La polla, c'est la tradition colombienne de chaque Mondial : la bande (le « parche » — famille, bureau, amis) met de l'argent dans une cagnotte commune (la « vaca »), tout le monde pronostique les scores, et celui qui a le plus de points à la fin remporte le prix. En plus, il y a des jokers, des bonus champion et meilleur buteur, et La Recocha — des questions folles inventées par la bande elle-même. L'argent, s'il y en a, se règle entre amis, hors de l'appli.", zh: "Polla 是哥伦比亚每届世界杯的传统：朋友圈（“parche” — 家人、同事、朋友）凑一个奖池（“vaca”），大家预测比分，最后积分最高的人赢得奖品。此外还有百搭、冠军和最佳射手的奖励竞猜，以及 La Recocha — 朋友们自己发明的搞怪问题。钱（如果有的话）由朋友们线下解决。",
  ...
  "g.recochaSub": { es: "Las preguntas locas del parche", en: "Your crew's crazy side questions", de: "Die verrückten Zusatzfragen deiner Crew", it: "Le domande folli della banda", pt: "As perguntas malucas da galera", fr: "Les questions folles de la bande", zh: "朋友们的搞怪问题", zht: "朋友們的搞怪問題" },
  ...
  "g.bonusClosed": { es: "Cerrados — mire los del parche", en: "Locked — see everyone's picks", de: "Gesperrt — sieh dir alle Tipps an", it: "Chiusi — guarda quelli della banda", pt: "Fechado — veja os da galera", fr: "Verrouillés — regarde ceux de la bande", zh: "已锁定 — 看看大家的选择", zht: "已鎖定 — 看看大家的選擇" },
  "g.bonusSoon": { es: "Cierran pronto, ¡pilas!", en: "Closing soon — don't sleep!", de: "Schließt bald — nicht verpennen!", it: "Chiudono presto — sveglia!", pt: "Fecha logo — se liga!", fr: "Ça ferme bientôt — fonce !", zh: "即将截止，抓紧！", zht: "即將截止，抓緊！" },
  ...
  "s.winner": { es: "Solo el ganador o empate", en: "Winner or draw only", de: "Nur Sieger oder Remis", it: "Solo vincente o pareggio", pt: "Só o vencedor ou empate", fr: "Vainqueur ou nul seulement", zh: "仅胜负正确", zht: "僅勝負正確" },
  "s.teamGoals": { es: "Pegarle a los goles de un equipo (extra)", en: "One team's goals right (extra)", de: "Tore eines Teams richtig (extra)", it: "Gol di una squadra azzeccati (extra)", pt: "Gols de um time certos (extra)", fr: "Buts d'une équipe trouvés (extra)", zh: "猜中一队进球数（加分）", zht: "猜中一隊進球數（加分）" },
  "s.result": { es: "Ganador o empate correcto", en: "Correct winner or draw", de: "Richtiger Sieger oder Remis", it: "Vincente o pareggio corretto", pt: "Vencedor ou empate correto", fr: "Vainqueur ou nul correct", zh: "胜负正确", zht: "勝負正確" },
  ...
  "s.multipliers": { es: "Eliminatorias multiplican los puntos", en: "Knockout rounds multiply points", de: "K.-o.-Runden multiplizieren die Punkte", it: "Le eliminatorie moltiplicano i punti", pt: "Mata-mata multiplica os pontos", fr: "Les phases finales multiplient les points", zh: "淘汰赛积分加倍", zht: "淘汰賽積分加倍" },
  "s.unico": { es: "Único acertado — solo usted pega el exacto", en: "Sole exact — only you nail the score", de: "Allein exakt — nur du triffst das Ergebnis", it: "Unico esatto — solo tu azzecchi il risultato", pt: "Único exato — só você acerta o placar", fr: "Seul exact — toi seul trouves le score", zh: "独中 — 只有你猜中比分", zht: "獨中 — 只有你猜中比分" },
  ...
  "s.note": {
    ...
    fr: "En phase finale, seules les 90 minutes comptent — ni prolongation ni tirs au but. Les questions de la recocha valent ce que décide l'organisateur.", zh: "淘汰赛只计 90 分钟常规时间 — 不含加时和点球。Recocha 问题的分值由主持人设定。",
  ...
  "f.r32": { es: "Dieciseisavos", en: "Round of 32", de: "Sechzehntelfinale", it: "Sedicesimi", pt: "16 avos de final", fr: "16es de finale", zh: "32 强", zht: "32 強" },
  "f.r16": { es: "Octavos", en: "Round of 16", de: "Achtelfinale", it: "Ottavi", pt: "Oitavas de final", fr: "8es de finale", zh: "16 强", zht: "16 強" },
  "f.qf": { es: "Cuartos", en: "Quarter-final", de: "Viertelfinale", it: "Quarti", pt: "Quartas de final", fr: "Quart de finale", zh: "四分之一决赛", zht: "四分之一決賽" },
  "f.sf": { es: "Semifinal", en: "Semi-final", de: "Halbfinale", it: "Semifinale", pt: "Semifinal", fr: "Demi-finale", zh: "半决赛", zht: "準決賽" },
  ...
  "f.reg90": { es: "en los 90 · terminó {h}–{a}", en: "after 90 · ended {h}–{a}", de: "nach 90 · Endstand {h}–{a}", it: "nei 90 · finita {h}–{a}", pt: "nos 90 · terminou {h}–{a}", fr: "après 90 min · fini {h}–{a}", zh: "90 分钟比分 · 最终 {h}–{a}", zht: "90 分鐘比分 · 最終 {h}–{a}" },
  "f.yourPick": { es: "Su pronóstico:", en: "Your pick:", de: "Dein Tipp:", it: "Il tuo pronostico:", pt: "Seu palpite:", fr: "Ton prono :", zh: "你的预测：", zht: "你的預測：" },
  "f.noPickPailas": { es: "no marcó — pailas", en: "no pick — tough luck", de: "kein Tipp — Pech gehabt", it: "nessun pronostico — peccato", pt: "sem palpite — já era", fr: "pas de prono — dommage", zh: "没预测 — 可惜啦", zht: "沒預測 — 可惜啦" },
  ...
  "f.minus": { es: "Menos goles {team}", en: "Fewer goals {team}", de: "Weniger Tore {team}", it: "Meno gol {team}", pt: "Menos gols {team}", fr: "Moins de buts {team}", zh: "减少{team}进球", zht: "減少{team}進球" },
  "f.plus": { es: "Más goles {team}", en: "More goals {team}", de: "Mehr Tore {team}", it: "Più gol {team}", pt: "Mais gols {team}", fr: "Plus de buts {team}", zh: "增加{team}进球", zht: "增加{team}進球" },
  ...
  "b.closedLine": { es: "Ya cerraron — estos son los del parche.", en: "Locked — here's what everyone picked.", de: "Gesperrt — das hat die Crew getippt.", it: "Chiusi — ecco cosa ha scelto la banda.", pt: "Fechado — esses são os palpites da galera.", fr: "Verrouillés — voilà les choix de tout le monde.", zh: "已截止 — 这是大家的选择。", zht: "已截止 — 這是大家的選擇。" },
  "b.closesAt": { es: "Cierran el {when} (su hora).", en: "Lock on {when} (your time).", de: "Schließen am {when} (deine Zeit).", it: "Chiudono il {when} (tua ora).", pt: "Fecha em {when} (seu horário).", fr: "Verrouillage le {when} (ton heure).", zh: "截止时间：{when}（你的时区）。", zht: "截止時間：{when}（你的時區）。" },
  "b.noDeadline": { es: "Quien organiza todavía no ha fijado el cierre.", en: "The organizer hasn't set the deadline yet.", de: "Der Organisator hat noch keine Frist gesetzt.", it: "Chi organizza non ha ancora fissato la scadenza.", pt: "Quem organiza ainda não definiu o prazo.", fr: "L'organisateur n'a pas encore fixé l'échéance.", zh: "主持人尚未设定截止时间。", zht: "主辦人尚未設定截止時間。" },
  "b.champion": { es: "Campeón", en: "Champion", de: "Weltmeister", it: "Campione", pt: "Campeão", fr: "Champion", zh: "冠军", zht: "冠軍" },
  "b.runnerUp": { es: "Subcampeón", en: "Runner-up", de: "Vizeweltmeister", it: "Secondo posto", pt: "Vice-campeão", fr: "Finaliste", zh: "亚军", zht: "亞軍" },
  ...
  "r.closest": { es: "al más cercano", en: "closest wins", de: "näheste gewinnt", it: "vince il più vicino", pt: "mais próximo ganha", fr: "le plus proche gagne", zh: "最接近者得分", zht: "最接近者得分" },
  ...
  "r.closestOpt": { es: "Gana quien más se acerque (en vez de exacto)", en: "Closest answer wins (instead of exact)", de: "Näheste Antwort gewinnt (statt exakt)", it: "Vince la risposta più vicina (invece dell'esatta)", pt: "Ganha quem chegar mais perto (em vez de exato)", fr: "La réponse la plus proche gagne (au lieu d'exacte)", zh: "最接近的回答得分（而非完全一致）", zht: "最接近的回答得分（而非完全一致）" },
  "r.resolve": { es: "Resolver", en: "Settle", de: "Entscheiden", it: "Risolvi", pt: "Resolver", fr: "Trancher", zh: "裁定", zht: "裁定" },
  "r.toApprove": { es: "En votación del parche", en: "Up for a crew vote", de: "Crew-Abstimmung läuft", it: "In votazione della banda", pt: "Em votação da galera", fr: "Au vote de la bande", zh: "朋友们投票中", zht: "朋友們投票中" },
  ...
  "r.nobody": { es: "Nadie respondió.", en: "Nobody answered.", de: "Keiner hat geantwortet.", it: "Nessuno ha risposto.", pt: "Ninguém respondeu.", fr: "Personne n'a répondu.", zh: "没有人回答。", zht: "沒有人回答。" },
  ...
  "r.proposeSub": {
    ...
    fr: "N'importe quoi : « combien de danses salsa choke ? », « le commentateur pleure-t-il si la Colombie gagne ? »", zh: "什么都行：“会有几段 salsa choke 舞？”、“哥伦比亚赢了解说员会哭吗？”",
  ...
  "r.optionsHint": { es: "(una por línea, solo para tipo “Opciones”)", en: "(one per line, only for multiple choice)", de: "(eine pro Zeile, nur bei Auswahl)", it: "(una per riga, solo per scelta multipla)", pt: "(uma por linha, só para múltipla escolha)", fr: "(une par ligne, seulement pour le choix multiple)", zh: "（每行一个，仅选择题需要）", zht: "（每行一個，僅選擇題需要）" },
  ...
  "r.propose": { es: "Mandársela al parche", en: "Send it to the crew", de: "Ab an die Crew", it: "Mandala alla banda", pt: "Mandar pra galera", fr: "Envoie-la à la bande", zh: "发给朋友们", zht: "發給朋友們" },
  ...
  "set.regen": { es: "Regenerar enlace (invalida el anterior)", en: "Regenerate link (invalidates the old one)", de: "Link erneuern (alter wird ungültig)", it: "Rigenera link (invalida il precedente)", pt: "Gerar novo link (invalida o anterior)", fr: "Régénérer le lien (invalide l'ancien)", zh: "重新生成链接（旧链接失效）", zht: "重新產生連結（舊連結失效）" },
  ...
  "set.bonusCloseSub": { es: "Hasta cuándo se puede pronosticar campeón, goleador, etc.", en: "Until when champion, top scorer, etc. can be picked.", de: "Bis wann Weltmeister, Torschützenkönig usw. getippt werden können.", it: "Fino a quando si possono pronosticare campione, capocannoniere, ecc.", pt: "Até quando dá pra apostar em campeão, artilheiro, etc.", fr: "Jusqu'à quand on peut pronostiquer champion, buteur, etc.", zh: "冠军、最佳射手等竞猜的截止时间。", zht: "冠軍、最佳射手等競猜的截止時間。" },
  "set.save": { es: "Guardar", en: "Save", de: "Speichern", it: "Salva", pt: "Salvar", fr: "Enregistrer", zh: "保存", zht: "儲存" },
  "set.crew": { es: "El parche ({n})", en: "The crew ({n})", de: "Die Crew ({n})", it: "La banda ({n})", pt: "A galera ({n})", fr: "La bande ({n})", zh: "成员（{n}）", zht: "成員（{n}）" },
  "set.organiza": { es: "organiza", en: "organizer", de: "Organisator", it: "organizza", pt: "organiza", fr: "organisateur", zh: "主持人", zht: "主辦人" },

  // ---- create group ----
  "new.eyebrow": { es: "Nueva polla", en: "New polla", de: "Neue Polla", it: "Nuova polla", pt: "Novo bolão", fr: "Nouvelle polla", zh: "新竞猜", zht: "新競猜" },
  "new.title": { es: "Arme su polla", en: "Set up your polla", de: "Stell deine Polla auf", it: "Crea la tua polla", pt: "Monte seu bolão", fr: "Monte ta polla", zh: "创建你的竞猜", zht: "建立你的競猜" },
  ...
  "new.namePh": { es: "Polla de la oficina", en: "Office polla", de: "Büro-Polla", it: "Polla dell'ufficio", pt: "Bolão do trabalho", fr: "Polla du bureau", zh: "办公室竞猜", zht: "辦公室競猜" },
  ...
  "new.unicoSub": { es: "+5 si solo usted pega el marcador exacto", en: "+5 if you're the only one with the exact score", de: "+5, wenn nur du das exakte Ergebnis triffst", it: "+5 se sei l'unico col risultato esatto", pt: "+5 se só você acertar o placar exato", fr: "+5 si tu es le seul à trouver le score exact", zh: "若只有你猜中比分，+5 分", zht: "若只有你猜中比分，+5 分" },
  ...
  "new.create": { es: "¡Armar la polla!", en: "Let's go!", de: "Los geht's!", it: "Si parte!", pt: "Bora!", fr: "C'est parti !", zh: "开整！", zht: "開玩！" },
  ...
  "preset.clasica.d": {
    ...
    fr: "La feuille traditionnelle : 1 pt résultat, 3 pts score exact, +1 pour la différence de buts.", zh: "传统玩法：胜负 1 分，比分全中 3 分，净胜球 +1 分。",
  ...
  "preset.marcador_o_nada.d": {
    ...
    fr: "Pour les audacieux : 4 pts résultat, 10 pts score exact, et les phases finales multiplient.", zh: "勇者玩法：胜负 4 分，全中 10 分，淘汰赛加倍。",
  ...
  "preset.escalonada.d": {
    ...
    fr: "Paliers exclusifs : exact 10 / vainqueur + différence 5 / vainqueur 2 (+1 buts d'une équipe). Un joker par tour double un match.", zh: "阶梯计分：全中 10 / 胜负+净胜球 5 / 胜负 2（+1 猜中一队进球）。每轮一个百搭让该场翻倍。",
  ...
  "mail.subject": { es: "{code} — su código, se lo manda Tania", en: "{code} — your code, from Tania", de: "{code} — dein Code, von Tania", it: "{code} — il tuo codice, da Tania", pt: "{code} — seu código, da Tania", fr: "{code} — ton code, de la part de Tania", zh: "{code} — 你的验证码，Tania 发来", zht: "{code} — 你的驗證碼，Tania 發來" },
  "mail.body": {
