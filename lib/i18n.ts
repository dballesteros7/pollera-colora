...
const M: Record<string, Msg> = {
  ...
  "f.alsoAll": { es: "También en mis otras pollas", en: "Also in my other pollas", de: "Auch in meinen anderen Pollas", it: "Anche nelle mie altre pollas", fr: "Aussi dans mes autres pollas", pt: "Também nos meus outros bolões", zh: "同时应用到我的其他竞猜", zht: "同時套用到我的其他競猜", nl: "Ook in mijn andere pollas" },
