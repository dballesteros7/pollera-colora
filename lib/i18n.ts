...
const M: Record<string, Msg> = {
  ...
  "badge.final": { es: "finalizado", en: "final", de: "Endstand", it: "finita", pt: "final", fr: "terminé", zh: "已结束", zht: "已結束", nl: "afgelopen" },
  ...
  "comodin": { es: "Comodín ×2", en: "Wildcard ×2", de: "Joker ×2", it: "Jolly ×2", pt: "Coringa ×2", fr: "Joker ×2", zh: "百搭 ×2", zht: "百搭 ×2", nl: "Joker ×2" },
  ...
  "name.q": { es: "¿Cómo le decimos en las pollas?", en: "What should we call you in the pollas?", de: "Wie sollen wir dich in den Pollas nennen?", it: "Come ti chiamiamo nelle pollas?", pt: "Como te chamamos nos bolões?", fr: "Comment on t'appelle dans les pollas ?", zh: "在竞猜里怎么称呼你？", zht: "在競猜裡怎麼稱呼你？", nl: "Hoe noemen we je in de pollas?" },
  ...
  "home.yourPollas": { es: "Sus pollas", en: "Your pollas", de: "Deine Pollas", it: "Le tue pollas", pt: "Seus bolões", fr: "Tes pollas", zh: "我的竞猜", zht: "我的競猜", nl: "Jouw pollas" },
  ...
  "f.qf": { es: "Cuartos", en: "Quarterfinals", de: "Viertelfinale", it: "Quarti", pt: "Quartas de final", fr: "Quart de finale", zh: "四分之一决赛", zht: "8 強", nl: "Kwartfinales" },
  ...
  "f.alsoAll": { es: "Copiar a mis otras pollas", en: "Copy to my other pollas", de: "In meine anderen Pollas kopieren", it: "Copia nelle mie altre pollas", fr: "Copier dans mes autres pollas", pt: "Copiar para meus outros bolões", zh: "同时复制到我的其他竞猜", zht: "同時複製到我的其他競猜", nl: "Kopieer naar mijn andere pollas" },
  ...
  "r.yourVote": { es: "su voto", en: "your vote", de: "deine Stimme", it: "il tuo voto", pt: "seu voto", fr: "ton vote", zh: "你的投票", zht: "你的投票", nl: "jouw stem" },
  ...
  "r.choice": { es: "Opciones", en: "Multiple choice", de: "Auswahl", it: "Scelta multipla", pt: "Múltipla escolha", fr: "Choix multiple", zh: "选择题", zht: "選擇題", nl: "Meerkeuze" },
  ...
  "set.you": { es: "Su nombre en las pollas", en: "Your name in the pollas", de: "Dein Name in den Pollas", it: "Il tuo nome nelle pollas", pt: "Seu nome nos bolões", fr: "Ton nom dans les pollas", zh: "你在竞猜中的名字", zht: "你在競猜中的名字", nl: "Je naam in de pollas" },
  "set.youHint": { es: "Así lo verá el parche en todas sus pollas.", en: "This is how every crew sees you, in all your pollas.", de: "So sieht dich die Crew in allen deinen Pollas.", it: "Così ti vedrà la combriccola in tutte le tue pollas.", pt: "É assim que a galera te vê em todos os seus bolões.", fr: "C'est comme ça que ta bande te voit dans toutes tes pollas.", zh: "所有竞猜里的朋友都会看到这个名字。", zht: "所有競猜裡的朋友都會看到這個名字。", nl: "Zo zien je maten je in al je pollas." },
  ...
  "preset.escalonada": { es: "Escalonada con comodín", en: "Tiered with wildcard", de: "Gestaffelt mit Joker", it: "A livelli con jolly", pt: "Escalonada com coringa", fr: "Par paliers avec joker", zh: "阶梯+百搭", zht: "階梯+百搭", nl: "Trapsgewijs met joker" },
  "preset.escalonada.d": {
  ...
  "recap.rankLine": { es: "Puesto {rank} de {n} en su polla", en: "{rank} of {n} in your polla", de: "Platz {rank} von {n} in deiner Polla", it: "{rank}º su {n} nella tua polla", pt: "{rank}º de {n} na sua polla", fr: "{rank}e sur {n} dans ta polla", zh: "在你的竞猜中排第 {rank} / 共 {n} 人", zht: "在你的競猜中排第 {rank} / 共 {n} 人", nl: "{rank} van {n} in je polla" },
  ...
  "recap.aliasHint": { es: "Apodo — no es su nombre real", en: "Alias — not their real name", de: "Deckname — nicht der echte Name", it: "Soprannome — non è il vero nome", pt: "Apelido — não é o nome real", fr: "Pseudo — pas son vrai nom", zh: "化名——并非真实姓名", zht: "化名——並非真實姓名", nl: "Schuilnaam — niet de echte naam" },
  ...
  "recap.buddy": { es: "Su parcero", en: "Your buddy", de: "Dein Kumpel", it: "Il tuo compagno", pt: "Seu parceiro", fr: "Ton acolyte", zh: "你的搭档", zht: "你的搭檔", nl: "Je maatje" },
  "recap.buddyPolla": { es: "Su parcero en la polla", en: "Your buddy in your polla", de: "Dein Kumpel in deiner Polla", it: "Il tuo compagno nella tua polla", pt: "Seu parceiro na sua polla", fr: "Ton acolyte dans ta polla", zh: "你在本竞猜的搭档", zht: "你在本競猜的搭檔", nl: "Je maatje in je polla" },
  "recap.buddyGlobal": { es: "Su parcero entre todas las pollas", en: "Your buddy across all pollas", de: "Dein Kumpel über alle Pollas", it: "Il tuo compagno tra tutte le polle", pt: "Seu parceiro entre todas as pollas", fr: "Ton acolyte toutes pollas confondues", zh: "你在所有竞猜中的搭档", zht: "你在所有競猜中的搭檔", nl: "Je maatje over alle polla's" },
  "recap.buddyBoth": { es: "Su parcero, en su polla y en todas", en: "Your buddy, in your polla and beyond", de: "Dein Kumpel, in deiner Polla und überall", it: "Il tuo compagno, nella tua polla e ovunque", pt: "Seu parceiro, na sua polla e em todas", fr: "Ton acolyte, dans ta polla et partout", zh: "你的搭档（本竞猜及所有竞猜）", zht: "你的搭檔（本競猜及所有競猜）", nl: "Je maatje, in je polla en daarbuiten" },
  ...
  "recap.notEligible": { es: "Entra al ranking global cuando su polla tenga al menos dos jugadores con pronósticos.", en: "You'll join the global ranking once your polla has at least two players with predictions.", de: "Du kommst ins globale Ranking, sobald deine Polla mindestens zwei Spieler mit Tipps hat.", it: "Entrerai nella classifica globale quando la tua polla avrà almeno due giocatori con pronostici.", pt: "Você entra no ranking global quando sua polla tiver pelo menos dois jogadores com palpites.", fr: "Tu rejoindras le classement global dès que ta polla aura au moins deux joueurs avec des pronostics.", zh: "当你的竞猜中至少有两名玩家做出预测时，你就会进入全局排名。", zht: "當你的競猜中至少有兩名玩家做出預測時，你就會進入全域排名。", nl: "Je komt in de wereldwijde ranglijst zodra je polla minstens twee spelers met voorspellingen heeft." },
  ...
  "recap.view": { es: "Ver resumen", en: "View recap", de: "Rückblick ansehen", it: "Vedi riepilogo", pt: "Ver resumo", fr: "Voir le récap", zh: "查看回顾", zht: "查看回顧", nl: "Bekijk overzicht" },
  ...
  "g.recapReady": { es: "¡Ya salió! Mire cómo le fue y compárese con todas las pollas.", en: "It's out! See how you did and compare across all pollas.", de: "Da ist er! Sieh, wie es lief, und vergleich dich über alle Pollas.", it: "È pronto! Guarda com'è andata e confrontati con tutte le polle.", pt: "Saiu! Veja como você foi e compare entre todas as pollas.", fr: "C'est dispo ! Vois ton résultat et compare-toi à toutes les pollas.", zh: "出炉啦！看看你的表现，并和所有竞猜对比。", zht: "出爐啦！看看你的表現，並和所有競猜對比。", nl: "Hij is er! Zie hoe je het deed en vergelijk over alle polla's." },
  "g.recapReadyBadge": { es: "¡Listo!", en: "Ready!", de: "Fertig!", it: "Pronto!", pt: "Pronto!", fr: "Dispo !", zh: "已出炉", zht: "已出爐", nl: "Klaar!" },
  "g.recapSub": { es: "Mire cómo le fue y compárese.", en: "See how you did and compare.", de: "Sieh, wie es lief, und vergleiche dich.", it: "Guarda com'è andata e confrontati.", pt: "Veja como você foi e se compare.", fr: "Vois comment tu t'en sors et compare-toi.", zh: "看看你的表现并对比一下。", zht: "看看你的表現並比較一下。", nl: "Zie hoe je het deed en vergelijk." },
};
