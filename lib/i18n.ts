...
const M: Record<string, Msg> = {
  ...
  "s.joker": { es: "Comodín — uno por ronda, dobla ese partido", en: "Wildcard — one per round, doubles that match", de: "Joker — einer pro Runde, verdoppelt das Spiel", it: "Jolly — uno per turno, raddoppia quella partita", pt: "Coringa — um por rodada, dobra aquele jogo", fr: "Joker — un par tour, double ce match", zh: "百搭 — 每轮一个，该场得分翻倍", zht: "百搭 — 每輪一個，該場得分翻倍", nl: "Joker — één per ronde, verdubbelt die wedstrijd" },
