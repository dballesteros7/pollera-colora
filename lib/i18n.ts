...
const M: Record<string, Msg> = {
  ...
  "g.bonusClosingTitle": { es: "El bono está por cerrar", en: "Bonus picks are closing", de: "Bonus schließt bald", it: "Il bonus sta per chiudere", pt: "O bônus vai fechar", fr: "Le bonus va fermer", zh: "Bonus 即将截止", zht: "Bonus 即將截止", nl: "Bonus sluit binnenkort" },
  "g.bonusClosingSub": { es: "Cierra el {when} (fin de la fase de grupos) — completa los tuyos.", en: "Closes {when} (end of the group phase) — finish yours.", de: "Schließt {when} (Ende der Gruppenphase) — mach deine fertig.", it: "Chiude il {when} (fine dei gironi) — completa i tuoi.", pt: "Fecha em {when} (fim da fase de grupos) — termine os seus.", fr: "Ferme le {when} (fin des groupes) — termine les tiens.", zh: "{when} 截止（小组赛结束）— 快完成你的选择。", zht: "{when} 截止（小組賽結束）— 快完成你的選擇。", nl: "Sluit {when} (einde groepsfase) — maak die van jou af." },
  ...
  "b.closesGroupPhase": { es: "Cierra el {when} — fin de la fase de grupos.", en: "Closes {when} — end of the group phase.", de: "Schließt {when} — Ende der Gruppenphase.", it: "Chiude il {when} — fine della fase a gironi.", pt: "Fecha em {when} — fim da fase de grupos.", fr: "Ferme le {when} — fin de la phase de groupes.", zh: "{when} 截止 — 小组赛结束。", zht: "{when} 截止 — 小組賽結束。", nl: "Sluit {when} — einde groepsfase." },
  "b.closedGroupPhase": { es: "Cerrado — terminó la fase de grupos.", en: "Closed — the group phase is over.", de: "Geschlossen — die Gruppenphase ist vorbei.", it: "Chiuso — la fase a gironi è finita.", pt: "Fechado — a fase de grupos acabou.", fr: "Fermé — la phase de groupes est terminée.", zh: "已截止 — 小组赛已结束。", zht: "已截止 — 小組賽已結束。", nl: "Gesloten — de groepsfase is voorbij." },
  ...
  "r.closesWeekend": { es: "⏰ La Recocha cierra el {when}. ¡Meta sus preguntas y respuestas antes de que se acabe el finde!", en: "⏰ La Recocha closes {when}. Get your questions and answers in before the weekend's out!", de: "⏰ La Recocha schließt am {when}. Stell deine Fragen und Antworten rein, bevor das Wochenende vorbei ist!", it: "⏰ La Recocha chiude il {when}. Inserisci domande e risposte prima della fine del weekend!", pt: "⏰ A Recocha fecha {when}. Mande suas perguntas e respostas antes do fim de semana acabar!", fr: "⏰ La Recocha ferme le {when}. Pose tes questions et réponses avant la fin du week-end !", zh: "⏰ La Recocha 将于 {when} 关闭。趁周末结束前赶紧提交你的问题和答案！", zht: "⏰ La Recocha 將於 {when} 關閉。趁週末結束前趕緊提交你的問題和答案！", nl: "⏰ La Recocha sluit {when}. Stel je vragen en antwoorden in vóór het weekend voorbij is!" },
  "r.closedAll": { es: "La Recocha ya cerró. ¡Gracias por la recocha, parce! 🎉", en: "La Recocha is closed. Thanks for the recocha, crew! 🎉", de: "La Recocha ist geschlossen. Danke für die Recocha, Leute! 🎉", it: "La Recocha è chiusa. Grazie per la recocha, raga! 🎉", pt: "A Recocha fechou. Valeu pela recocha, galera! 🎉", fr: "La Recocha est fermée. Merci pour la recocha, la bande ! 🎉", zh: "La Recocha 已关闭。谢谢大家的参与！🎉", zht: "La Recocha 已關閉。謝謝大家的參與！🎉", nl: "La Recocha is gesloten. Bedankt voor de recocha, maten! 🎉" },
  "r.proposeClosed": { es: "Ya no se pueden proponer más preguntas.", en: "No more questions can be proposed.", de: "Es können keine Fragen mehr vorgeschlagen werden.", it: "Non si possono più proporre domande.", pt: "Não dá mais para propor perguntas.", fr: "On ne peut plus proposer de questions.", zh: "无法再提交新问题。", zht: "無法再提交新問題。", nl: "Er kunnen geen vragen meer worden voorgesteld." },
  ...
  // Per-team flavour on the over-cap toast: the localized core ("99 is the max")
  // plus a native-language tag kept verbatim everywhere — same spirit as the
  // eggs' own untranslated chants.
  "ui.scoreErrCol": { es: "No se guardó — máximo 99 goles. ¡Viva la Sele! 🦋", en: "Save failed — 99 goals is the max. ¡Viva la Sele! 🦋", de: "Nicht gespeichert — maximal 99 Tore. ¡Viva la Sele! 🦋", it: "Non salvato — massimo 99 gol. ¡Viva la Sele! 🦋", fr: "Échec — 99 buts maximum. ¡Viva la Sele! 🦋", nl: "Niet opgeslagen — maximaal 99 goals. ¡Viva la Sele! 🦋", pt: "Não salvou — máximo 99 gols. ¡Viva la Sele! 🦋", zh: "保存失败 — 最多 99 球。¡Viva la Sele! 🦋", zht: "儲存失敗 — 最多 99 球。¡Viva la Sele! 🦋" },
  "ui.scoreErrSui": { es: "No se guardó — máximo 99 goles. Hopp Schwiiz! 🏔️", en: "Save failed — 99 goals is the max. Hopp Schwiiz! 🏔️", de: "Nicht gespeichert — maximal 99 Tore. Hopp Schwiiz! 🏔️", it: "Non salvato — massimo 99 gol. Hopp Schwiiz! 🏔️", fr: "Échec — 99 buts maximum. Hopp Schwiiz! 🏔️", nl: "Niet opgeslagen — maximaal 99 goals. Hopp Schwiiz! 🏔️", pt: "Não salvou — máximo 99 gols. Hopp Schwiiz! 🏔️", zh: "保存失败 — 最多 99 球。Hopp Schwiiz! 🏔️", zht: "儲存失敗 — 最多 99 球。Hopp Schwiiz! 🏔️" },
  "ui.scoreErrCan": { es: "No se guardó — máximo 99 goles. Sorry, eh! 🍁", en: "Save failed — 99 goals is the max. Sorry, eh! 🍁", de: "Nicht gespeichert — maximal 99 Tore. Sorry, eh! 🍁", it: "Non salvato — massimo 99 gol. Sorry, eh! 🍁", fr: "Échec — 99 buts maximum. Sorry, eh! 🍁", nl: "Niet opgeslagen — maximaal 99 goals. Sorry, eh! 🍁", pt: "Não salvou — máximo 99 gols. Sorry, eh! 🍁", zh: "保存失败 — 最多 99 球。Sorry, eh! 🍁", zht: "儲存失敗 — 最多 99 球。Sorry, eh! 🍁" },
